...
import com.exorath.vampirism.libraries.jnbt.ByteArrayTag;
import com.exorath.vampirism.libraries.jnbt.CompoundTag;
import com.exorath.vampirism.libraries.jnbt.NBTInputStream;
import com.exorath.vampirism.libraries.jnbt.ShortTag;
import com.exorath.vampirism.libraries.jnbt.Tag;
...
public class Schematic {
	...
	public static long pasteSchematic(final World world, final Location loc, Schematic schematic,final Building b) {
		final int i = 5;
					...
					final int fZ = z;
							Bukkit.getScheduler().scheduleSyncDelayedTask(Bukkit.getPluginManager().getPlugin("Vampirism"),new Runnable(){
								...
								public void run(){
									...
									block.setMetadata("building", new FixedMetadataValue(Bukkit.getPluginManager().getPlugin("Vampirism"), b));
								}
							},i * x + i * y + i * z);
